...
<Note>
For real-time dictation, streaming providers like Microsoft Azure, Deepgram, and Soniox provide the lowest latency. Batch providers like Groq Whisper and OpenAI process after you finish speaking.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Transcription is slow">
    1. For real-time dictation, switch to a streaming provider (Azure, Deepgram, Soniox)
