...
| Dark button | <img src="https://file.enconvo.com/badges/mcp-install-dark.svg?v=20260628-folded-logo" alt="Add to Enconvo" height="44" /> |
| Light button | <img src="https://file.enconvo.com/badges/mcp-install-light.svg?v=20260628-folded-logo" alt="Add to Enconvo" height="44" /> |
...
```markdown Markdown
[![Add to Enconvo](https://file.enconvo.com/badges/mcp-install-dark.svg?v=20260628-folded-logo)](enconvo://mcp/install?name=your-server&config=BASE64_CONFIG)
```

```html HTML
<a href="enconvo://mcp/install?name=your-server&config=BASE64_CONFIG">
  <img src="https://file.enconvo.com/badges/mcp-install-dark.svg?v=20260628-folded-logo" alt="Add to Enconvo" height="44" />
</a>
```
