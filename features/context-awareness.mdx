...
<Warning>
Context attached to a request may be sent to the chosen model or processing provider. Automatic capture and background features have their own controls; review the active sources and provider settings before working with sensitive content.
</Warning>
