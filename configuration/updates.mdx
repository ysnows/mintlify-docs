---
title: "Updates"
description: "Choose Production, Beta, or Dev updates and install new EnConvo versions"
---
...
| **Dev** | Development testing | More frequent development builds, separate from Beta |
...
<Steps>
  ...
  <Step title="Choose a channel">
    Set **Update Channel** to **Production**, **Beta**, or **Dev**.
  </Step>
</Steps>

A fresh Dev installation defaults to Dev. Existing saved channel choices are preserved. Switching channels does not necessarily downgrade an already installed newer build.
